...
import { COMMERCE_STATUS, RIF_TYPE } from '../../domain/commerce.entity';

export class GetCommerceByIdResponseDTO {
  @ApiProperty({
    maxLength: 36,
  ...
  @ApiProperty({
    enum: COMMERCE_STATUS,
    enumName: 'COMMERCE_STATUS',
    description: 'Estatus del comercio',
    example: COMMERCE_STATUS.ACTIVE,
    required: true,
  })
  @IsEnum(COMMERCE_STATUS, {
    message: 'status debe ser un valor del enum COMMERCE_STATUS',
  })
